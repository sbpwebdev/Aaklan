            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#StudentType-all">List View</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#StudentType-profile">Profile</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#StudentType-add">Add</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-8 col-md-12 col-sm-12">
                                <div class="card">
                                    ...
                                    <form class="card-body" action="{{ route('StudentTypes.update',  $StudentType->StudentType_id) }}" method="post">
                                    @csrf
                                    @method('PUT')
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Name <span class="text-danger">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="StudentType_name" id="StudentType_name" placeholder="Enter StudentType name" value="{{ old('StudentType_name', $StudentType->StudentType_name) }}">
                                            </div>
                                        </div>
