            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Grade-all">List View</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Grade-profile">Profile</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Grade-add">Add</a></li>
                    </ul>
                </div>
            </div>
        </div>
