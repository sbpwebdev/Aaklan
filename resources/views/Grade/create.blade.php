            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link " data-toggle="tab" href="{{ route('grades.index')  }}">List View</a></li>
                        <!-- <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Grade-profile">Profile</a></li> -->
                        <li class="nav-item"><a class="nav-link active" href="{{ route('grades.create')  }}">Add</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-8 col-md-12 col-sm-12">
                                <div class="card">
                                    ...
                                    <form class="card-body" action="{{ route('grades.store') }}" method="post">
                                    @csrf
