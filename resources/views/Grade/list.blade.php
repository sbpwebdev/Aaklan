            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href=href="{{ route('grades.index')  }}">List View</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="Grade-profile">
                        <div class="row">
                            <div class="col-xl-4 col-md-12">
                                ...
                                <div class="card">
									...
									<div class="card-body">
										<p>Hello I am Celena Anderson a Clerk in Xyz College USA. I love to work with all my college Grade and seniour professors.</p>
										<ul class="list-group">
