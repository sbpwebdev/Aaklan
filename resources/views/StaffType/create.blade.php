            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#StaffType-all">List View</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#StaffType-profile">Profile</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#StaffType-add">Add</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-8 col-md-12 col-sm-12">
                                <div class="card">
                                    ...
                                    <form class="card-body" action="{{ route('StaffTypes.store') }}" method="post">
                                    @csrf
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Name <span class="text-danger">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="StaffType_name" id="StaffType_name" placeholder="Enter StaffType name">
                                            </div>
                                        </div>
