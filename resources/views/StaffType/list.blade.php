            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    <div class="header-action">
                        <h1 class="page-title">StaffType</h1>
                        <ol class="breadcrumb page-breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Aaklan</a></li>
                            <li class="breadcrumb-item active" aria-current="page">StaffType</li>
                        </ol>
                    </div>
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href=href="{{ route('StaffTypes.index')  }}">List View</a></li>
                        <!-- <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#StaffType-profile">Profile</a></li> -->
                        <li class="nav-item"><a class="nav-link" href="{{ route('StaffTypes.create')  }}">Add</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    <div class="tab-pane active" id="StaffType-all">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                        ...
                        <div class="table-responsive card">
                            <table class="table table-hover table-vcenter table-striped mb-0 text-nowrap">
                                ...
                                @foreach ($StaffTypes as $StaffType)
                                    <tr>
                                        <td>{{ $StaffType->StaffType_name }}</td>
                                     
                                        <td>
                                           
                                            <a href="{{ route('StaffTypes.edit',$StaffType->StaffType_id)  }}" >
                                            <button type="button" class="btn btn-icon btn-sm" title="Edit">
                                            
                                            <i class="fa fa-edit"></i>
                                        </button>
                                            </a>
                                            <form action="{{ route('StaffTypes.destroy', $StaffType->StaffType_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="tab-pane" id="StaffType-profile">
                        <div class="row">
                            <div class="col-xl-4 col-md-12">
                                ...
                                <div class="card">
									...
									<div class="card-body">
										<p>Hello I am Celena Anderson a Clerk in Xyz College USA. I love to work with all my college StaffType and seniour professors.</p>
										<ul class="list-group">
