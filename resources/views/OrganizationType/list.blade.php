            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" href="{{ route('OrganizationTypes.index')  }}">List View</a></li>
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    <div class="tab-pane active" id="OrganizationType-all">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                ...
                                @foreach ($OrganizationTypes as $OrganizationType)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('OrganizationTypes.edit',$OrganizationType->OrganizationType_id)  }}" >
                                            <button type="button" class="btn btn-icon btn-sm" title="Edit">
                                            
                                            <i class="fa fa-edit"></i>
                                        </button>
                                            </a>
                                            <form action="{{ route('OrganizationTypes.destroy', $OrganizationType->OrganizationType_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="tab-pane" id="OrganizationType-profile">
                        <div class="row">
                            <div class="col-xl-4 col-md-12">
                                ...
                                <div class="card">
									...
									<div class="card-body">
										<p>Hello I am Celena Anderson a Clerk in Xyz College USA. I love to work with all my college OrganizationType and seniour professors.</p>
										<ul class="list-group">
