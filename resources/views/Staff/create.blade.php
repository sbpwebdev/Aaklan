                        ...
                        <div class="row clearfix">
                            <div class="col-lg-8 col-md-12 col-sm-12">
                                <div class="card">
                                    ...
                                    <form class="card-body" action="{{ route('staffs.store') }}" method="post"  enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="Staff_email" id="Staff_email" placeholder="Enter Staff email">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Contact <span class="text-danger">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="Staff_contact" id="Staff_contact" placeholder="Enter contact">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="Staff Organization" name="Staff_organization_id" id="Staff_organization_id" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="Staff_type_id" id="Staff_type_id"  placeholder="Select Staff type">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Staff Course </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="Staff Course" name="Staff_course_id" id="Staff_course_id"  >
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">City </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="City" name="Staff_city" id="Staff_city"  >
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Staff Skills </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="Staff Skills" name="Staff_skills" id="Staff_skills"  >
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Staff Photo</label>
                                            <div class="col-md-9">
                                                <input type="file" class="dropify" name="Staff_images" id="Staff_images">
