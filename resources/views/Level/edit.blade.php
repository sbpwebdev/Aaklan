            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Level-all">List View</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Level-profile">Profile</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Level-add">Add</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-8 col-md-12 col-sm-12">
                                <div class="card">
                                    ...
                                    <form class="card-body" action="{{ route('Levels.update',  $Level->Level_id) }}" method="post">
                                    @csrf
                                    @method('PUT')
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Name <span class="text-danger">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="Level_name" id="Level_name" placeholder="Enter Level name" value="{{ old('Level_name', $Level->Level_name) }}">
                                            </div>
                                        </div>
