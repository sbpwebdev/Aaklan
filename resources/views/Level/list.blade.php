            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href=href="{{ route('Levels.index')  }}">List View</a></li>
                        <!-- <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Level-profile">Profile</a></li> -->
                        <li class="nav-item"><a class="nav-link" href="{{ route('Levels.create')  }}">Add</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    <div class="tab-pane active" id="Level-all">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                ...
                                @foreach ($Levels as $Level)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('Levels.edit',$Level->Level_id)  }}" >
                                            <button type="button" class="btn btn-icon btn-sm" title="Edit">
                                            
                                            <i class="fa fa-edit"></i>
                                        </button>
                                            </a>
                                            <form action="{{ route('Levels.destroy', $Level->Level_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="tab-pane" id="Level-profile">
                        <div class="row">
                            <div class="col-xl-4 col-md-12">
                                ...
                                <div class="card">
									...
									<div class="card-body">
										<p>Hello I am Celena Anderson a Clerk in Xyz College USA. I love to work with all my college Level and seniour professors.</p>
										<ul class="list-group">
